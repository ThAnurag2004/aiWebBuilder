...
const Welcome = () => (
  <div className="flex flex-col items-center justify-center h-full border-2 rounded-xl dark:border-gray-700">
...
const Dashboard = () => {
  ...
  return (
    <div className=" flex flex-col bg-gray-100 dark:bg-gray-900">
      {/* Persistent Header */}
      <div className="p-4 border-b border-gray-300 dark:border-gray-700 flex items-center gap-4 bg-white dark:bg-gray-800">
        <button
          onClick={() => navigate("/")}
